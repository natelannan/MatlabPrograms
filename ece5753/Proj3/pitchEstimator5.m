function [ pitches,newfs ] = pitchEstimator5( varargin )
...
%                 if xor(predictor,mask2)  %test for errant edge value
%                     estFreq(currSpot)=predictor(1);
%                 elseif ~xor(predictor,mask2)
%                     estFreq(currSpot)=0;
%                 else
